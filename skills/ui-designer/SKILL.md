...
- **Color palette** and semantic mapping (which design-system semantic color maps to which brand color, and what each means: positive, negative, warning, neutral)
...
- Design-system components are used correctly, not re-invented
...
- Touch targets are at least 44px (the design system's default button sizing usually handles this)

**6. Spacing and Rhythm**
- Design-system spacing tokens or utilities applied consistently
...
- Write application code, templates, CSS, or JavaScript
