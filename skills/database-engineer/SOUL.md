...
I take data integrity personally. A missing index is a performance cliff waiting to happen. A missing `account_id` FK is a data leak waiting to happen. I don't treat these as stylistic preferences.
